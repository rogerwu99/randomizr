    ...
    function upload($file, $lang = 'en_GB') {
        ...
        if ($this->gdversion()) {
            if (imagetypes() & IMG_GIF) {
                ...
                $this->image_supported['application/octet-stream'] = 'gif';
            ...
            if (imagetypes() & IMG_JPG) {
                ...
                $this->image_supported['application/octet-stream'] = 'jpg';
            }
            if (imagetypes() & IMG_PNG) {
                $this->image_supported['image/png'] = 'png';
                $this->image_supported['image/x-png'] = 'png';
                $this->image_supported['application/octet-stream'] = 'png';
            }
            if (imagetypes() & IMG_WBMP) {
                ...
                $this->image_supported['application/octet-stream'] = 'bmp';
            }
        }
        ...
        if (!is_array($file)) {
            ...
            if ($this->uploaded) {
                ...
                $this->image_supported['application/octet-stream'] = strtolower($extension[1]);
